...
const startApplication = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const socketServer = SockerServerFactory_1.SocketServerFactory.createServerWith(socketConfig.protocol, {
        ...
        messageCallback: (findMessage) => {
            ...
            const messages = MessageFactory_1.MessageFactory.createMessageFrom(brokerMessage);
...
const stopApplication = () => __awaiter(void 0, void 0, void 0, function* () {
